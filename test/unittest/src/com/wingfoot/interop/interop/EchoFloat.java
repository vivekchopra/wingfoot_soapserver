...
public class EchoFloat  implements InteropInterface
{
    ...
    **/
	   ...
	   // requestEnvelope.setSchemaInstance(schemaInstance);
	    ...
	    call.setMappingRegistry(registry);
	    call.addParameter("inputFloat",
                new Float("123.45"), Class.forName("java.lang.Float"));
	    call.setMethodName("echoFloat");
	    ...
	    Envelope responseEnvelope = call.invoke(transport);
	       ...
	       throw new Exception ("Response envelope is null");
	        ...
	        return "Fault: " + f.getFaultString();
	            ...
	            Float returnString=null;
                    if (responseEnvelope.getParameter(0) instanceof String) {
                        returnString=new Float((String)responseEnvelope.getParameter(0));
		    }
		    else
                        returnString 
                           = (Float) responseEnvelope.getParameter(0);
		     if ( !returnString.toString().startsWith("123"))
