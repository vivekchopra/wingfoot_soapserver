...
public class InteropClient {
    ...
    public void init (String fileName)
	 ...
	 fos.write(("<h3>Results of Round 2 Base Test Suite as defined in http://www.whitemesa.com/interop.htm</h3><br>").getBytes());
	 ...
	 * the proper service
	 */
	 Class theClass = Class.forName("com.wingfoot.interop.interop."+methodName);
