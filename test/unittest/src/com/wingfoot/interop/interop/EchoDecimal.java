...
public class EchoDecimal  implements InteropInterface
{
	...
	**/
            BigDecimal original = new BigDecimal(123.454);
	   ...
	   // requestEnvelope.setSchemaInstance(schemaInstance);
	    ...
	    call.addParameter("inputDecimal", original, Class.forName("java.math.BigDecimal") );
	    call.setMethodName("echoDecimal");
	       ...
	       throw new Exception ("Response envelope is null");
	        ...
	        return "Fault: " + f.getFaultString();
	               ...
	               if (responseEnvelope.getParameter(0) instanceof String) {
                            returnString=
                                new BigDecimal((String)responseEnvelope.getParameter(0));
		       }
		       else {
                           returnString = (BigDecimal) responseEnvelope.getParameter(0);
		       }

		       if ( returnString.compareTo(original) != 0)
