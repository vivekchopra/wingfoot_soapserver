...
public class EchoVoid  implements InteropInterface
{
	   ...
	   // requestEnvelope.setSchema(schema);
	    ...
	    Envelope responseEnvelope = call.invoke(transport);
		  ...
		  return "Fault: " + f.getFaultString();
		     ...
		     Object returnParameter = responseEnvelope.getParameter(0);
	             if (returnParameter!=null)
		          throw new Exception ("Error: Got Back Data");
            }
            return "OK";
	} //run
