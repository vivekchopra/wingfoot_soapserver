...
public class EchoString  implements InteropInterface
{
   ...
   **/
	    ...
	    //call.addParameter("inputString", "Hello World ëõø");
	    call.addParameter("inputString", "Hello World", Class.forName("java.lang.String"));
	    ...
	    Envelope responseEnvelope = call.invoke(transport);
		  ...
		  return "Fault: " + f.getFaultString();
	              ...
	              // if ( !returnString.equals("Hello World ëõø"))
